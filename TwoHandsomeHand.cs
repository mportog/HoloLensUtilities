...
{/// <summary>
/// script é uma adaptação do TWOHANDMANIPULATABLE
/// unica mudanca e a alteracao do SCALE LOGIC SCRIPT
/// </summary>
    public class TwoHandsomeHand : MonoBehaviour, IInputHandler, ISourceStateHandler
    {
        ...
        private ManipulationMode manipulationMode = ManipulationMode.Move;
        ...
        private TwoHandXesque scaleLogic;
        ...
        private void OnTwoHandManipulationStarted(ManipulationMode newState)
        {
            ...
            {
                scaleLogic.Setup(handsPressedLocationsMap, hostTransform.GetChild(1));
            }
#endif // UNITY_2017_2_OR_NEWER
        }
